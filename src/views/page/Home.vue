                    ...
                    <div class="col-lg-3">
                        <div class="card card-body mb-4">
                            <article class="icontext">
                                ...
                                <div class="text">
                                    <h6 class="mb-1 card-title"> <RouterLink class="main" to="/catrgories" > Categories </RouterLink> </h6>
                                    <span> 5 </span>
                                    <span class="text-sm"> Click here to manage Ibommarket catrgories </span>
                                </div>
                            </article>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="card card-body mb-4">
                            <article class="icontext">
                                ...
                                <div class="text">
                                    <h6 class="mb-1 card-title">Sub categories</h6>
                                    <span>15</span>
                                    <span class="text-sm"> Click here to manage Ibommarket sub catrgories </span>
                                </div>
                            </article>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="card card-body mb-4">
                            <article class="icontext">
                                ...
                                <div class="text">
                                    <h6 class="mb-1 card-title">Advert banners</h6>
                                    <span> 3 </span>
                                    <span class="text-sm"> Click here to manage Ibommarket adverts </span>
                                </div>
                            </article>
                        </div>
                    </div>
